...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        $query = "INSERT INTO crud_028_jamaah (nama_lengkap, no_paspor_ktp, jenis_kelamin, alamat, no_hp, paket_umrah, nama_mitra) 
                VALUES ('$nama_lengkap', '$no_paspor_ktp', '$jenis_kelamin', '$alamat', '$no_hp', '$paket_umrah', '$nama_mitra')";
        
        if ($conn->query($query)) {
            header("Location: jamaah.php?success=added");
            exit;
        } else {
...
<head>
    ...
    <title>Tambah Jamaah - Sistem Manajemen Umrah</title>
        ...
        <main class="main-content">
            ...
            <div class="content-area">
                <div class="content-header">
                    <h1><i class="fas fa-user-plus"></i> Tambah Jamaah</h1>
                ...
                <div class="form-container">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="jamaahForm" onsubmit="return validateJamaahForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="no_paspor_ktp" name="no_paspor_ktp" value="<?php echo isset($no_paspor_ktp) ? $no_paspor_ktp : ''; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <label>
                                    <input type="radio" name="jenis_kelamin" value="Laki-laki" <?php echo (isset($jenis_kelamin) && $jenis_kelamin == 'Laki-laki') ? 'checked' : ''; ?>> Laki-laki
                                </label>
                                <label>
                                    <input type="radio" name="jenis_kelamin" value="Perempuan" <?php echo (isset($jenis_kelamin) && $jenis_kelamin == 'Perempuan') ? 'checked' : ''; ?>> Perempuan
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="paket_umrah" name="paket_umrah">
                                ...
                                <option value="Ekonomi" <?php echo (isset($paket_umrah) && $paket_umrah == 'Ekonomi') ? 'selected' : ''; ?>>Ekonomi</option>
                                <option value="Reguler" <?php echo (isset($paket_umrah) && $paket_umrah == 'Reguler') ? 'selected' : ''; ?>>Reguler</option>
                                <option value="VIP" <?php echo (isset($paket_umrah) && $paket_umrah == 'VIP') ? 'selected' : ''; ?>>VIP</option>
                                <option value="VVIP" <?php echo (isset($paket_umrah) && $paket_umrah == 'VVIP') ? 'selected' : ''; ?>>VVIP</option>
                            </select>
                            ...
                            <select id="nama_mitra" name="nama_mitra">
                                ...
                                if ($result_mitra->num_rows > 0) {
                                    while ($row = $result_mitra->fetch_assoc()) {
                                        $selected = (isset($nama_mitra) && $nama_mitra == $row['id']) ? 'selected' : '';
